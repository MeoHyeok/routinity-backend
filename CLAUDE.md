...
Covered by unit tests (53 cases total across `computeScores`, `computeDailyScore`, `goalsExistingBy`, `computeInsights`, and the report builders) plus live-endpoint verification.
